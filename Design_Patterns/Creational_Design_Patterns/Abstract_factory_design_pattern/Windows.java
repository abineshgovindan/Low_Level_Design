...
public class Windows implements LaptopFactory{
    ...
    public Windows(String processorName, int processorCount, int threds, String gpuName, int vram) {
    ...
    public IProcessor ProcessorSpec() {
        if(this.ProcessorName =="Intel"){
            ...
            return new AMD(this.ProcessorName, this.processorCount,
                    this.Threds);
        }
